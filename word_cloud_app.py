...
if uploaded_file:
    ...
    st.sidebar.markdown("---")
    st.sidebar.subheader("Follow for more")
    # add a youtube video
    st.sidebar.video("https://www.youtube.com/channel/UC0t1eqGosX8WsMpoawHO6rQ")
    st.sidebar.markdown("---")
    # add author name and info
    st.sidebar.markdown("Created by: [Engr. Muhammad Osaid Bin Shakoor](https://github.com/MOsaidJutt)")
